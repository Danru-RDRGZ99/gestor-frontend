            ...
            controls=[
                ...
                ft.Container(
                    content=ft.Column([
                        ft.Text("📅 Gestión de Horarios", 
                               ...
                               text_align=ft.TextAlign.CENTER),
                        Card(ft.Column([
                            ft.Text("Selecciona Laboratorio y Día:", size=16, weight=ft.FontWeight.W_600),
                            ft.Row([
                                ft.Container(dd_lab, expand=2),
                                ft.Container(days_selector, expand=3),
                ...
                ft.Container(
                    content=ft.Row([
                        ...
                        ft.Container(
                            content=Card(ft.Column([
                                ft.Text("Agregar/Editar Horario", size=18, weight=ft.FontWeight.W_600),
                                ft.Text("Configura nuevos horarios o edita los existentes", 
                                       size=14, color=ft.Colors.GREY_600),
                                ft.Divider(height=20),
                                ft.ResponsiveRow([
                                    ft.Container(dd_inicio, col=12),
                                    ft.Container(dd_fin, col=12),
                                    ft.Container(dd_tipo, col=12),
                                ], spacing=10),
                        ...
                        ft.Container(
                            content=ft.Column([
                                ft.Row([
                                    ft.Text("Horarios Configurados", size=20, weight=ft.FontWeight.W_600),
                                    ft.Text(f"Laboratorio: {lab_map.get(state['selected_lab'], 'General')}", 
                                           size=14, color=ft.Colors.GREY_600),
